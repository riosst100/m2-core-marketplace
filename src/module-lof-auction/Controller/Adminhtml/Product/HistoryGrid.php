 ...
 */
class HistoryGrid extends Product
{
    /**
     * @var LayoutFactory
     */
    ...
    public function execute()
    {
        ...
        $resultLayout->getLayout()->getBlock('lofauction.form.edit.tab.history')
            ->setProductsRelated($this->getRequest()->getPost('relatedbids', null));
        return $resultLayout;
    }
    ...
    {
        return $this->_authorization->isAllowed('Lof_Auction::history_grid');
    }
}
