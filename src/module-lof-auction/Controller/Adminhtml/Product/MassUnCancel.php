 ...
 */
class massUnCancel extends Action
{
    /**
     * @var Filter
     */
    ...
    public function execute()
    {
        ...
        $collection->addFieldToFilter("auction_status", AuctionStatus::STATUS_CANCELED);
        ...
        $this->messageManager->addSuccess(__('A total of %1 record(s) have been un-canceled.', $collectionSize));
    ...
    {
        return $this->_authorization->isAllowed('Lof_Auction::mass_cancel');
    }
}
