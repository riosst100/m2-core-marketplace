 ...
 */
class MaxAbsentee extends Extended
{
    /**
     * Core registry
     *
     ...
     */
    private $_maxAbsenteeBidFactory;
     ...
     * @param MaxAbsenteeBidFactory $maxAbsenteeBidFactory
    ...
    public function __construct(
        ...
        MaxAbsenteeBidFactory $maxAbsenteeBidFactory,
        ...
        $this->_maxAbsenteeBidFactory = $maxAbsenteeBidFactory;
    ...
    {
        $collection = $this->_maxAbsenteeBidFactory->create()->getCollection()->addFieldToFilter('auction_id', $this->getProduct()->getId());
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            'max_absentee_amount',
            [
                'header' => __('Max Absentee Price'),
                'type' => 'currency',
                'currency_code' => (string)$this->_scopeConfig->getValue(
                    \Magento\Directory\Model\Currency::XML_PATH_CURRENCY_BASE,
                    \Magento\Store\Model\ScopeInterface::SCOPE_STORE
                ),
                'index' => 'max_absentee_amount',
                'header_css_class' => 'col-name',
                'column_css_class' => 'col-name'
            ]
        );
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Lof\Auction\Block\Adminhtml\Product\Edit\Tab\Renderer\Status'
            ]
        );
        $this->addColumn(
            'created_at',
    ...
    public function getGridUrl()
    {
        return $this->_getData(
            ...
            'lofauction/product/maxabsenteeGrid',
            [
