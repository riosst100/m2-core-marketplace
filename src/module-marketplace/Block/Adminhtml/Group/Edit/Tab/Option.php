...
namespace CoreMarketplace\MarketPlace\Block\Adminhtml\Group\Edit\Tab;

use Magento\Backend\Block\Widget\Tab\TabInterface;

class Option extends \Lof\MarketPlace\Block\Adminhtml\Group\Edit\Tab\Option
{
    /**
     * Prepare form
     *
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'label' => __('Can Use Group'),
                'title' => __('Can Use Group'),
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'label' => __('Can Use Auction'),
                'title' => __('Can Use Auction'),
                'name' => 'can_use_auction',
                'options' => ['1' => __('Yes'), '0' => __('No')]
            ]
        );
        ...
        $fieldset->addField(
            ...
            'select',
            [
                'label' => __('Can Use Pre-Order'),
                'title' => __('Can Use Pre-Order'),
                'name' => 'can_use_preorder',
                'options' => ['1' => __('Yes'), '0' => __('No')]
            ]
        );
